...
public class IOPanel<T extends ITypedSlot<U>, U, V extends Connection<T, U>> extends Panel {
    private final BiFunction<IFrameEntity, PanelState, ? extends IOPanelEntity<T, U, V>> panelEntityConstructor;

    public IOPanel(BiFunction<IFrameEntity, PanelState, ? extends IOPanelEntity<T, U, V>> panelEntityConstructor) {
